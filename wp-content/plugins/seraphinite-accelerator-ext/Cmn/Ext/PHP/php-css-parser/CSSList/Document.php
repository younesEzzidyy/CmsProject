...
class Document extends CSSBlockList {
	...
	public static function parse(ParserState $oParserState) {
		$oDocument = new Document($oParserState->currentPos());
		CSSList::parseList($oParserState, $oDocument);
		return $oDocument;
	}

	public function parseEx(ParserState $oParserState) {
		CSSList::parseList($oParserState, $this);
	}
	...
	public function render(string &$sResult, \seraph_accel\Sabberworm\CSS\OutputFormat $oOutputFormat = null) {
		if($oOutputFormat === null) {
			$oOutputFormat = new \seraph_accel\Sabberworm\CSS\OutputFormat();
		}
